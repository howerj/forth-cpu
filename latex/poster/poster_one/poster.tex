...
\headerbox{Basic Concepts}{name=concepts,column=0,below=task}{
% Extensible computer
% Reusable CPU core.
% Educational.
% Of further use to students and myself
%% Continue work after university.
}

\headerbox{Github}{name=github,column=0,below=concepts}{
\smaller
